...
2) Go to the `Data Science Projects` section and access your application's project named `lucas-maysun-problematic-sep110`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `lucas-maysun-problematic-sep110-notebook`.
...
5) In the terminal, run `cd lucas-maysun-problematic-sep110` to navigate to your sample app's directory.
